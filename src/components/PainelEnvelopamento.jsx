                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        height: 32,
                        borderRadius: 8,
                        border: isExpandido ? '1px solid #16a34a' : '1px solid var(--slate-700, rgba(255, 255, 255, 0.2))',
                        background: isExpandido ? '#16a34a' : 'var(--bg-card-hover, rgba(255, 255, 255, 0.06))',
                        color: isExpandido ? '#ffffff' : 'inherit',
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                        cursor: 'pointer',
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                              ...
                              <button
                                ...
                                style={{
                                  ...
                                  height: 28,
                                  borderRadius: 6,
                                  border: isRomExpandido ? '1px solid #0284c7' : '1px solid var(--slate-700, rgba(255, 255, 255, 0.2))',
                                  background: isRomExpandido ? '#0284c7' : 'var(--bg-card-hover, rgba(255, 255, 255, 0.06))',
                                  color: isRomExpandido ? '#ffffff' : 'inherit',
                                  display: 'flex',
                                  alignItems: 'center',
                                  justifyContent: 'center',
                                  cursor: 'pointer',
